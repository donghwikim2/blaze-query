...
/**
 * Data fetcher for managed policies attached directly to IAM users.
 *
 * @author Donghwi Kim
 * @since 1.0.0
 */
public class AwsIamUserAttachedPolicyDataFetcher implements DataFetcher<AwsIamUserAttachedPolicy>, Serializable {
	...
	public DataFormat getDataFormat() {
		return DataFormats.beansConvention( AwsIamUserAttachedPolicy.class, AwsConventionContext.INSTANCE );
	}
}
